...
[下载 Mac 1.3.6](https://github.com/HackerChi-Hub/localbrain-releases/releases/download/v1.3.6/LocalBrain_1.3.6_aarch64.dmg) · [Windows 1.2.68 下载页](https://github.com/HackerChi-Hub/localbrain-releases/releases/tag/v1.2.68)

Mac 安装包 SHA-256：`2b96824a0931327f37490804929f1498b8fe9c65f1ba89deb64e9ecdb8c7c7ac`

- **Mac：1.3.6**，适用于 Apple Silicon。渲染出错时显示错误而不是黑屏；上下文内存预算标明生效范围。
