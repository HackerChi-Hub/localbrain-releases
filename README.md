...
[下载 Mac 1.3.2](https://github.com/HackerChi-Hub/localbrain-releases/releases/download/v1.3.2/LocalBrain_1.3.2_aarch64.dmg) · [Windows 1.2.68 下载页](https://github.com/HackerChi-Hub/localbrain-releases/releases/tag/v1.2.68)

Mac 安装包 SHA-256：`3777151b1d0543c9ec03f5c2de2e0eb3ce6e465c401837876ec130bbccd3d581`

- **Mac：1.3.2**，适用于 Apple Silicon，新增简体中文、繁体中文和英文界面。
