...
[下載 Mac 1.3.8](https://github.com/HackerChi-Hub/localbrain-releases/releases/download/v1.3.8/LocalBrain_1.3.8_aarch64.dmg) · [Windows 1.2.68 下載頁](https://github.com/HackerChi-Hub/localbrain-releases/releases/tag/v1.2.68)

Mac 安裝包 SHA-256：`821bf9aaf23f731324b6579c815f9825e9a7f9f5c5555d9bbbeac563dc28aa64`

- **Mac：1.3.8**，適用於 Apple Silicon。渲染出錯時顯示錯誤而不是黑屏；上下文記憶體預算標明生效範圍。
